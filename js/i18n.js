...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      "hero.videoAria": "Vídeo del telar en el taller",
      ...
      "cat.all": "Todo",
      "cat.bordado": "Bordado",
      "cat.bordados": "Bordados",
      "cat.instalacion": "Instalación",
      "cat.volumen": "Volumen",
      "cat.telar": "Telar",
      "cat.dibujo": "Papel",
      "cat.arcilla": "Volumen",
    ...
    en: {
      ...
      "hero.videoAria": "Loom video from the studio",
      ...
      "cat.bordados": "Embroidery",
      "cat.instalacion": "Installation",
      "cat.volumen": "Volume",
      "cat.telar": "Weave",
      "cat.dibujo": "Paper",
      "cat.arcilla": "Volume",
    ...
    nl: {
      ...
      "hero.videoAria": "Video van het weefgetouw in het atelier",
      ...
      "cat.all": "Alles",
      "cat.bordado": "Borduur",
      "cat.bordados": "Borduurwerk",
      "cat.instalacion": "Installatie",
      "cat.volumen": "Volume",
      "cat.telar": "Weefsel",
      "cat.dibujo": "Papier",
      "cat.arcilla": "Volume",
    ...
    fr: {
      ...
      "hero.videoAria": "Vidéo du métier à tisser à l’atelier",
    ...
    de: {
      ...
      "hero.videoAria": "Webvideo aus dem Atelier",
  ...
  function getCategories() {
    return {
      all: t("cat.all"),
      bordados: t("cat.bordados"),
      dibujos: t("cat.dibujos"),
      instalacion: t("cat.instalacion"),
      plasticina: t("cat.plasticina"),
      telar: t("cat.telar"),
      volumen: t("cat.volumen"),
      bordado: t("cat.bordados"),
      dibujo: t("cat.dibujos"),
      arcilla: t("cat.plasticina"),
      obras: t("cat.telar"),
    };
  }
